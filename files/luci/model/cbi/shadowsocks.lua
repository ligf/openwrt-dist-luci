...
o = s:taboption("wan_ac", ListValue, "wan_work_mode", translate("Work Mode"))
o:value("gfw", translate("GFWList"))
o:value("chn", translate("CHNRoute"))
o.rmempty = false

o = s:taboption("wan_ac", DynamicList, "wan_db_dos", translate("Forwarded Domain"))
o.datatype = "hostname"
